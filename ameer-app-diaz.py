...
while True:
    user = api.get_user('KnightRobben')
    api.update_profile(name=f'ThatDudeinyourhouse|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : ThatDudeinyourhouse{follower_count(user)} Followers')
